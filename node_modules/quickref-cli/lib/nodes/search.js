...
export function search({ homePath = '', isHome, static_path, config } = {}) {
                    ...
                    children: [
                        {
                            ...
                            children: [
                                    ...
                                    children: [
                                        ...svgSearchNode,
                                        {
                                            ...
                                            properties: {
                                                id: ['mysearch-input'],
                                                type: 'search',
                                                placeholder: config.search?.placeholder || 'Search for cheatsheet',
                                                autocomplete: 'off',
                                            },
                                            children: [],
                                        },
                                ...
                                },
                                {
                                    ...
                                    children: [{ type: 'text', value: config.search?.cancel || 'Cancel' }],
                                },
                            ],
                        },
                        {
